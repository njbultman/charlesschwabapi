...
#' movement for a specific index in a data frame.
#'
...
#' @param frequency to return movers wit hthe specified directions of up or down. Valid values are 0, 1, 5, 10, 30, or 60. Default is NULL, which is zero (numeric).
#'
